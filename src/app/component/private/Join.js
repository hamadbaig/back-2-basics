const JoinTeamComponent = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center py-16 space-y-8 md:space-y-0 md:space-x-16">
      <div className="text-center md:text-left max-w-md">
        ...
        <a
          href="#"
          className="inline-block bg-green-900 text-white text-lg font-semibold py-2 px-4 rounded-full hover:bg-green-600 transition"
        >
          See Careers
        </a>
      </div>
