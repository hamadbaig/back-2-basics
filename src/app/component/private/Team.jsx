      ...
      <div className="py-16 bg-white">
        ...
        <div className="container mx-auto flex flex-col md:flex-row md:flex-wrap justify-center items-center space-y-12 md:space-y-0 md:space-x-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="flex flex-col items-center text-center md:text-left max-w-sm">
              <Image 
               width={100}
               height={100}
              src={member.imageSrc} 
              ...
              <h4 className="text-lg font-medium text-blue-600 mb-4">{member.title}</h4>
