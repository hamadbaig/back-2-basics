  ...
  return (
    <div className="py-8 px-4 md:px-16 bg-white text-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Divider */}
        <div className="hidden md:block w-1/6 h-1 bg-gradient-to-r from-green-300 to-green-600"></div>
        ...
        <div className="flex flex-col items-center text-center mb-8 md:mb-0 md:flex-1">
          ...
          <h3 className="text-lg font-bold text-green-600 mt-4">Applying</h3>
          <p className="text-gray-500 mt-2">
        ...
        {/* Divider */}
        <div className="hidden md:block w-1/6 h-1 bg-gradient-to-r from-green-300 to-blue-400"></div>
        ...
        <div className="flex flex-col items-center text-center md:flex-1">
          ...
          <h3 className="text-lg font-bold text-green-600 mt-4">Decision</h3>
          <p className="text-gray-500 mt-2">
        ...
        <div className="flex flex-col items-center text-center md:flex-1">
          ...
          <h3 className="text-lg font-bold text-green-600 mt-4">Selection</h3>
          <p className="text-gray-500 mt-2">
