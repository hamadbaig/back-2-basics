...
const Contact = () => {
  ...
  return (
    <section>
      <div class="relative  bg-[#62BC7B] mt-4 mb-4 h-auto ">
        <form
          ...
          <div class="pt-[4rem]">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div>
                <label
                  for="first-name"
                  class="block text-sm font-semibold leading-6 text-green-900"
                >
                  First name
                </label>
                <div class="mt-2.5">
            ...
            <div class="mt-8 flex justify-end">
              <button
                type="submit"
                class="rounded-md bg-green-900 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-900"
              >
                Send message
              </button>
            </div>
